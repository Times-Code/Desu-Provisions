...
const Footer = () => {
  return (
    <div className="flex py-16 w-full px-6 flex-col items-center flex-wrap fixed bottom-[0px] justify-evenly gap-5 mt-6 bg-rose-50 p-4 sm:flex-row dark:border-white/5">
