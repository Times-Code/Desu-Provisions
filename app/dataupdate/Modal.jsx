      ...
      {isOpen && (
        <div className="fixed inset-0 z-[300] bg-black/50 backdrop-blur-sm flex items-center justify-center">
          <div className="relative w-full max-w-6xl mx-auto my-6 px-4">
            <div className="relative flex flex-col w-full bg-white border-0 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] outline-none focus:outline-none">
              ...
              <div className="relative flex-auto p-6">
                {isLoading ? (
                  ...
                  <div className='overflow-auto h-[450px] overflow-y-auto'>
                    <Table>
                      <TableHeader>
                        <TableRow>
